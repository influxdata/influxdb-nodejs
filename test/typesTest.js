...
describe('Test that types are converted/checked correctly when writing', () => {
    ...
    describe('Bools', () => {
        ...
        it('should write booleans', (done) => {
            connection.connect()
                .then(() => connection.write([boolDataPoint1, boolDataPoint2, boolDataPoint3, boolDataPoint4, boolDataPoint5]))
    ...
    describe('Conflict string to float', () => {
        ...
        it('should write the initial float', (done) => {
            ...
            connectionPromise.then(() => connection.write([floatDataPoint])).then(done, done);
        });

        it('should catch the invalid string type', (done) => {
            const connectionPromise = connection.connect();
            connectionPromise.then(() => connection.write([stringDataPoint])).then(() => {
        ...
        it('should drop the float data', (done) => {
            done(util.dropMeasurement(connection, 'current'));
        });
    });
    ...
    describe('Conflict float to integer', () => {
        ...
        it('should write the initial int', (done) => {
            connection.write([integerDataPoint]).then(done, done);
        });

        it('should detect writing float into integer field', (done) => {
            const connectionPromise = connection.connect();
            connectionPromise.then(() => connection.write([floatDataPoint])).then(() => {
                done(new Error('Type check should fail'));
            }).catch(() => {
                done();
            });
        ...
        it('should drop the integer data', (done) => {
            done(util.dropMeasurement(connection, 'pulse'));
        });
    });
    ...
    describe('Conflict float to boolean', () => {
        ...
        it('should write the initial bool', (done) => {
            const connectionPromise = connection.connect();
            connectionPromise.then(() => connection.write([boolDataPoint])).then(done, done);
        });
        ...
        it('should drop the boolean data', (done) => {
            done(util.dropMeasurement(connection, 'connection'));
        });
    });
    ...
    describe('Conflict float to string', () => {
        ...
        it('should write the initial string', (done) => {
            const connectionPromise = connection.connect();
            connectionPromise.then(() => connection.write([stringDataPoint])).then(done, done);
        });
        ...
        it('should drop the string data', (done) => {
            done(util.dropMeasurement(connection, 'status'));
        });
    });
});
